...
async def main():
    dataset = load_from_disk('/var/csi/rawfile/replug/data/datasets/nq.hf')
    dataset = dataset['validation']

    # Initialize retrievers
    index_path = "/var/csi/rawfile/replug/data/wiki_embeddings.index"  # Path to the FAISS index
    chunks_path = "/var/csi/rawfile/replug/data/wiki_chunk_texts.pkl"  # Path to the chunk texts
